...
public class BooksApi extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (request.getRequestURI().equals("/Demo/BooksApi/DELETE")) {
    ...
    if (request.getRequestURI().equals("/Demo/BooksApi/UPDATE")) {
    ...
    if (request.getRequestURI().equals("/Demo/BooksApi/INSERT")) {
